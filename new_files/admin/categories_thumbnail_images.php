...
$a = new image_manipulation(DIR_FS_CATALOG_CATEGORIES_IMAGES . $categories_image_name, CATEGORIES_IMAGE_THUMBNAIL_WIDTH, CATEGORIES_IMAGE_THUMBNAIL_HEIGHT, DIR_FS_CATALOG_CATEGORIES_THUMBNAIL_IMAGES . $categories_image_name_process, IMAGE_QUALITY, '');
